...
export const ProjectInfoGrid = ({ project }: Props) => {
  ...
  return (
    <div className="md:bg-white rounded-xl w-full grid grid-cols-2 gap-x-2 gap-y-2 md:border md:border-muted-1/30 md:grid-cols-4 md:gap-x-0 md:gap-y-0 md:divide-x md:divide-muted-1/30 md:shadow-md md:shadow-muted-1/10">
